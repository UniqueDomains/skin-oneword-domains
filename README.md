# Available .SKIN One-Word Domains (19,575)
...
**Public extract:** 1,000 rows · **Live catalog:** 19,575 domains · **Median ask:** $126.74 · **High-demand under $2,500:** 18
...
| -------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ------------ |
| beautiful.skin | premium   | $812.50   | —             | high           | low    | 9      | name.com     |
...
> Unique Domains. *Available .SKIN One-Word Domains*. Version 2026-09-03. Public GitHub extract for the exact Unique Domains search represented by this repository.
